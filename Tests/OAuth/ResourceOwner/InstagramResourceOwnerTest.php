...
class InstagramResourceOwnerTest extends GenericOAuth2ResourceOwnerTest
{
    ...
    {
        $this->assertEquals(
            'https://api.instagram.com/oauth/authorize/?response_type=code&client_id=clientid&redirect_uri=http%3A%2F%2Fredirect.to%2F',
    ...
    {
        $this->assertEquals('', $this->resourceOwner->getOption('infos_url'));
    }
}
